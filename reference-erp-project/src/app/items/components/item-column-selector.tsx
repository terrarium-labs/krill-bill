...
import type { ItemTableColumnKey } from "./items-table";

export const CONFIGURABLE_COLUMNS: { id: ItemTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "item_code", label: "Item Code" },
    { id: "measure", label: "Stock" },
    { id: "pmc", label: "PMC" },
    { id: "sell_price", label: "Default Price" },
    { id: "margin", label: "Margin (%)" },
    { id: "description", label: "Description" },
    { id: "item_hierarchy", label: "Item Hierarchy" },
    { id: "created_at", label: "Created At" },
];

interface ItemColumnSelectorProps {
...
export function ItemColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: ItemColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as ItemTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as ItemTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as ItemTableColumnKey), 0, moved);
