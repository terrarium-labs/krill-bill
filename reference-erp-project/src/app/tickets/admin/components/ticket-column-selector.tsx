...
import type { TicketTableColumnKey } from "./tickets-table";

export const CONFIGURABLE_COLUMNS: { id: TicketTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
...
interface TicketColumnSelectorProps {
...
export function TicketColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: TicketColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as TicketTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as TicketTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as TicketTableColumnKey), 0, moved);
