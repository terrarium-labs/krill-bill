...
import type { TimeRecordsSummaryTableColumnKey } from "./time-records-summary-table";

export const CONFIGURABLE_COLUMNS: { id: TimeRecordsSummaryTableColumnKey; label: string }[] = [
    { id: "day", label: "Day" },
    { id: "employee", label: "Employee" },
    { id: "time_worked", label: "Time Worked" },
    { id: "balance", label: "Balance" },
    { id: "pending", label: "Status" },
];

interface TimeRecordsColumnSelectorProps {
...
export function TimeRecordsColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: TimeRecordsColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as TimeRecordsSummaryTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as TimeRecordsSummaryTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as TimeRecordsSummaryTableColumnKey), 0, moved);
