...
interface ClientDetailPageHourlyRatesProps {
    onAddHourlyRateClick?: () => void;
}

export interface ClientDetailPageHourlyRatesRef {
    refreshHourlyRates: () => void;
}

const ClientDetailPageHourlyRates = forwardRef<ClientDetailPageHourlyRatesRef, ClientDetailPageHourlyRatesProps>(({ onAddHourlyRateClick }, ref) => {
    ...
    const handleDeleteHourlyRate = async () => {
        ...
        try {
            const response = await deleteClientHourlyRate(orgId, clientId, hourlyRateToDelete.id);
            if (response?.success) {
                ...
                items={[
                    {
                        ...
                        icon: "external-link",
                        onClick: () => handleNavigateToHourlyRate(hourlyRate.id),
                    },
                    {
...
export default ClientDetailPageHourlyRates;
