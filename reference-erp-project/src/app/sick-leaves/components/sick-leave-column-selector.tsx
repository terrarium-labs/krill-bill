...
import type { SickLeavesColumnKey } from "./sick-leaves-table";

export const CONFIGURABLE_COLUMNS: { id: SickLeavesColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
...
interface SickLeaveColumnSelectorProps {
...
export function SickLeaveColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: SickLeaveColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as SickLeavesColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as SickLeavesColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as SickLeavesColumnKey), 0, moved);
