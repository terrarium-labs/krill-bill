...
import type { SalesInvoiceTableColumnKey } from "./sales-invoices-table";

export const CONFIGURABLE_COLUMNS: { id: SalesInvoiceTableColumnKey; label: string }[] = [
...
interface SalesInvoiceColumnSelectorProps {
...
export function SalesInvoiceColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: SalesInvoiceColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as SalesInvoiceTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as SalesInvoiceTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as SalesInvoiceTableColumnKey), 0, moved);
