...
import type { AbsenceTableColumnKey } from "./absences-table";

export const CONFIGURABLE_COLUMNS: { id: AbsenceTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "employee", label: "Employee" },
    { id: "absence_type", label: "Absence Type" },
    { id: "year", label: "Year" },
    { id: "date", label: "Date" },
    { id: "duration", label: "Duration" },
    { id: "start_date", label: "Start Date" },
    { id: "end_date", label: "End Date" },
    { id: "absence_counter", label: "Counter" },
    { id: "status", label: "Status" },
    { id: "notes", label: "Notes" },
    { id: "num_files", label: "Files" },
    { id: "responded_by", label: "Responded By" },
];

interface AbsenceColumnSelectorProps {
...
export function AbsenceColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: AbsenceColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as AbsenceTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as AbsenceTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as AbsenceTableColumnKey), 0, moved);
