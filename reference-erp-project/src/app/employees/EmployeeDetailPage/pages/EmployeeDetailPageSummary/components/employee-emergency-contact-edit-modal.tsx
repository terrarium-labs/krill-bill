...
const EmployeeEmergencyContactEditModal: React.FC<EmployeeEmergencyContactEditModalProps> = ({
    ...
    const onSubmit = async (data: EmergencyContactFormData) => {
        ...
        try {
            ...
            let response;
            if (emergencyContact) {
                response = await patchEmployeeEmergencyContact(orgId, employeeId, emergencyContact.id, payload);
            } else {
                response = await postEmployeeEmergencyContact(orgId, employeeId, payload);
            }
