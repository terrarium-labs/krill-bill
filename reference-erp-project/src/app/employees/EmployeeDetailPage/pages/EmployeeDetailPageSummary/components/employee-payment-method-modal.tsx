    ...
    const onSubmit = async (values: FormValues) => {
        ...
        try {
            ...
            if (mode === 'update' && paymentMethod?.id) {
                response = await patchEmployeePaymentsMethod(orgId, employeeId, paymentMethod.id, payload);
            } else {
                response = await postEmployeePaymentsMethod(orgId, employeeId, payload);
            }
