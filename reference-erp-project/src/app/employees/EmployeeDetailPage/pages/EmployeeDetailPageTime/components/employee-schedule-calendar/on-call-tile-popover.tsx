...
import OnCallShiftEmployeesAddModal from "@/app/on-call/pages/OnCallPageSchedule/components/on-call-shift-employees-add-modal";
import {
...
interface OnCallTilePopoverProps {
  ...
  segmentStart: Date;
  segmentEnd: Date;
  /** Time policy work hours for this day (default / special), shown above the assigned shift details. */
