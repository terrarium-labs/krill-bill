...
import type { IntegrationsTableColumnKey } from "./integrations-table";

export const CONFIGURABLE_COLUMNS: { id: IntegrationsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "type", label: "Service" },
    { id: "identity", label: "Identity" },
    { id: "connectedAt", label: "Connected" },
    { id: "status", label: "Status" },
    { id: "default", label: "Default" },
];

interface IntegrationColumnSelectorProps {
...
export function IntegrationColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: IntegrationColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as IntegrationsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as IntegrationsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as IntegrationsTableColumnKey), 0, moved);
