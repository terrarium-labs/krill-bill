...
import type { RolesTableColumnKey } from "./roles-table";

export const CONFIGURABLE_COLUMNS: { id: RolesTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
    { id: "num_permissions", label: "Permissions" },
    { id: "created_at", label: "Created At" },
];

interface RoleColumnSelectorProps {
...
export function RoleColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: RoleColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) => ids.includes(id as RolesTableColumnKey));
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as RolesTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as RolesTableColumnKey), 0, moved);
