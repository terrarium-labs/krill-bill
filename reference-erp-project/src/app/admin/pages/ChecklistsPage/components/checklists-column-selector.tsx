...
import type { ChecklistsTableColumnKey } from "./checklists-table";

export const CONFIGURABLE_COLUMNS: { id: ChecklistsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
];

interface ChecklistsColumnSelectorProps {
...
export function ChecklistsColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: ChecklistsColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as ChecklistsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as ChecklistsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as ChecklistsTableColumnKey), 0, moved);
