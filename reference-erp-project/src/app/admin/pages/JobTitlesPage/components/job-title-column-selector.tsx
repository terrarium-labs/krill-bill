...
import type { JobTitleTableColumnKey } from "./job-titles-table";

export const CONFIGURABLE_COLUMNS: { id: JobTitleTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
...
interface JobTitleColumnSelectorProps {
...
export function JobTitleColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: JobTitleColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) => ids.includes(id as JobTitleTableColumnKey));
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as JobTitleTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as JobTitleTableColumnKey), 0, moved);
