...
import type { ConversationsTableColumnKey } from "./conversations-table";

export const CONFIGURABLE_COLUMNS: { id: ConversationsTableColumnKey; label: string }[] = [
    { id: "group_id", label: "ID" },
    { id: "employee", label: "Employee" },
    { id: "number_of_messages", label: "Messages" },
    { id: "conversation_cost", label: "Cost" },
    { id: "last_message_status", label: "Status" },
    { id: "last_message_sent_at", label: "Last Message" },
    { id: "created_at", label: "Created At" },
];

interface ConversationColumnSelectorProps {
...
export function ConversationColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: ConversationColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as ConversationsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as ConversationsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as ConversationsTableColumnKey), 0, moved);
