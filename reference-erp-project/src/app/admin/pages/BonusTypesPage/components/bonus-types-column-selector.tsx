...
import type { BonusTypesTableColumnKey } from "./bonus-types-table";

export const CONFIGURABLE_COLUMNS: { id: BonusTypesTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
    { id: "amount", label: "Default Amount" },
];

interface BonusTypesColumnSelectorProps {
...
export function BonusTypesColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: BonusTypesColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as BonusTypesTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as BonusTypesTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as BonusTypesTableColumnKey), 0, moved);
