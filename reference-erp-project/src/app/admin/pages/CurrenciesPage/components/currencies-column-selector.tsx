...
import type { CurrenciesTableColumnKey } from "./currencies-table";

export const CONFIGURABLE_COLUMNS: { id: CurrenciesTableColumnKey; label: string }[] = [
    { id: "name", label: "Name" },
    { id: "symbol", label: "Symbol" },
    { id: "exchange_rate", label: "Exchange Rate" },
    { id: "updated_at", label: "Updated At" },
    { id: "is_fixed", label: "Is Fixed" },
];

interface CurrenciesColumnSelectorProps {
...
export function CurrenciesColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: CurrenciesColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as CurrenciesTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as CurrenciesTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as CurrenciesTableColumnKey), 0, moved);
