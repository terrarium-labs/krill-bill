...
import type { TimePoliciesTableColumnKey } from "./time-policies-table";

export const CONFIGURABLE_COLUMNS: { id: TimePoliciesTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
    { id: "flexibility", label: "Flexibility (min)" },
    { id: "default_overtime_multiplier", label: "Overtime Multiplier" },
    { id: "number_of_employees", label: "Employees" },
    { id: "number_of_slots", label: "Time Slots" },
    { id: "number_of_overtime_rules", label: "Overtime Rules" },
];

interface TimePolicyColumnSelectorProps {
...
export function TimePolicyColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: TimePolicyColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) => ids.includes(id as TimePoliciesTableColumnKey));
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as TimePoliciesTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as TimePoliciesTableColumnKey), 0, moved);
