...
import type { TaxonomyTableColumnKey } from "./taxonomy-table";

export const CONFIGURABLE_COLUMNS: { id: TaxonomyTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "type", label: "Type" },
    { id: "margin", label: "Margin" },
    { id: "num_items_hierarchy", label: "Items" },
...
export function TaxonomyColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: TaxonomyColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as TaxonomyTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as TaxonomyTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as TaxonomyTableColumnKey), 0, moved);
