...
import type { AbsencePolicyTableColumnKey } from "./absence-policies-table";

export const CONFIGURABLE_COLUMNS: { id: AbsencePolicyTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
    { id: "number_of_counters", label: "Number of Counters" },
];

interface AbsencePoliciesColumnSelectorProps {
...
export function AbsencePoliciesColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: AbsencePoliciesColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as AbsencePolicyTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as AbsencePolicyTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as AbsencePolicyTableColumnKey), 0, moved);
