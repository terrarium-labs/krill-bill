...
import type { AbsenceTypeTableColumnKey } from "./absence-types-table";

export const CONFIGURABLE_COLUMNS: { id: AbsenceTypeTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
...
interface AbsenceTypesColumnSelectorProps {
...
export function AbsenceTypesColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: AbsenceTypesColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as AbsenceTypeTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as AbsenceTypeTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as AbsenceTypeTableColumnKey), 0, moved);
