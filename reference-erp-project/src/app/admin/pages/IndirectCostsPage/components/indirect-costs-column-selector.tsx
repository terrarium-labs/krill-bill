...
import type { IndirectCostsTableColumnKey } from "./indirect-costs-table";

export const CONFIGURABLE_COLUMNS: { id: IndirectCostsTableColumnKey; label: string }[] = [
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
    { id: "entity", label: "Entity" },
    { id: "is_percentage", label: "Type" },
    { id: "ranges", label: "Ranges" },
];

interface IndirectCostsColumnSelectorProps {
...
export function IndirectCostsColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: IndirectCostsColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as IndirectCostsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as IndirectCostsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as IndirectCostsTableColumnKey), 0, moved);
