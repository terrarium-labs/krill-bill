...
import type { SkillTableColumnKey } from "./skills-table";

export const CONFIGURABLE_COLUMNS: { id: SkillTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
...
export function SkillsColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: SkillsColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as SkillTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as SkillTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as SkillTableColumnKey), 0, moved);
