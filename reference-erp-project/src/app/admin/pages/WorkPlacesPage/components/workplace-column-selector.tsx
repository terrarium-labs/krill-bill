...
import type { WorkplaceTableColumnKey } from "./workplaces-table";

export const CONFIGURABLE_COLUMNS: { id: WorkplaceTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
...
interface WorkplaceColumnSelectorProps {
...
export function WorkplaceColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: WorkplaceColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) => ids.includes(id as WorkplaceTableColumnKey));
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as WorkplaceTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as WorkplaceTableColumnKey), 0, moved);
