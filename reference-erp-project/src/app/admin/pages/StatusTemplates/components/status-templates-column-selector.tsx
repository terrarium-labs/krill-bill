...
import type { StatusTemplateTableColumnKey } from "./status-templates-table";

export const CONFIGURABLE_COLUMNS: { id: StatusTemplateTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
...
interface StatusTemplatesColumnSelectorProps {
...
export function StatusTemplatesColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: StatusTemplatesColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as StatusTemplateTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as StatusTemplateTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as StatusTemplateTableColumnKey), 0, moved);
