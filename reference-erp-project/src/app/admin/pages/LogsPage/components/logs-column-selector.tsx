...
import type { LogsTableColumnKey } from "./logs-table";

export const CONFIGURABLE_COLUMNS: { id: LogsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "user", label: "User" },
    { id: "req_method", label: "Method" },
    { id: "req_path", label: "Path" },
    { id: "res_status", label: "Status" },
...
export function LogsColumnSelector({
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as LogsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as LogsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as LogsTableColumnKey), 0, moved);
