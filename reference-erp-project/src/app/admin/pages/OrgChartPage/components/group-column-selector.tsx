...
import type { GroupsTableColumnKey } from "./groups-table";

export const CONFIGURABLE_COLUMNS: { id: GroupsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "type", label: "Type" },
    { id: "responsible", label: "Responsible" },
    { id: "num_employees_group", label: "Employees" },
...
export function GroupColumnSelector({
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) => ids.includes(id as GroupsTableColumnKey));
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as GroupsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as GroupsTableColumnKey), 0, moved);
