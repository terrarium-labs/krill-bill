...
import type { OrderTypesTableColumnKey } from "./order-types-table";

export const CONFIGURABLE_COLUMNS: { id: OrderTypesTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
];

interface OrderTypesColumnSelectorProps {
...
export function OrderTypesColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: OrderTypesColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as OrderTypesTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as OrderTypesTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as OrderTypesTableColumnKey), 0, moved);
