...
import type { SerialNumbersTableColumnKey } from "./serial-numbers-table";

export const CONFIGURABLE_COLUMNS: { id: SerialNumbersTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "entity", label: "Entity" },
    { id: "value", label: "Pattern" },
    { id: "last_num_value", label: "Last Number" },
    { id: "next_num_value", label: "Next Number" },
];

interface SerialNumbersColumnSelectorProps {
...
export function SerialNumbersColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: SerialNumbersColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as SerialNumbersTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as SerialNumbersTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as SerialNumbersTableColumnKey), 0, moved);
