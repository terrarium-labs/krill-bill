...
import type { TrainingsTableColumnKey } from "./trainings-table";

export const CONFIGURABLE_COLUMNS: { id: TrainingsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "title", label: "Title" },
    { id: "category", label: "Category" },
    { id: "delivery_type", label: "Type" },
    { id: "status", label: "Status" },
    { id: "visibility", label: "Visibility" },
    { id: "start_date", label: "Start Date" },
    { id: "end_date", label: "End Date" },
    { id: "provider", label: "Provider" },
    { id: "is_mandatory", label: "Mandatory" },
    { id: "enrolled_count", label: "Enrolled" },
];

interface TrainingColumnSelectorProps {
...
export function TrainingColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: TrainingColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as TrainingsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as TrainingsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as TrainingsTableColumnKey), 0, moved);
