...
import type { WarehouseTableColumnKey } from "./warehouses-table";

export const CONFIGURABLE_COLUMNS: { id: WarehouseTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "num_items", label: "Items" },
    { id: "status", label: "Status" },
    { id: "address", label: "Address" },
    { id: "country", label: "Country" },
    { id: "distance", label: "Distance" },
    { id: "time_to_travel", label: "Travel Time" },
    { id: "stock_rotation_type", label: "Policy" },
    { id: "vehicle", label: "Vehicle" },
];

interface WarehouseColumnSelectorProps {
...
export function WarehouseColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: WarehouseColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as WarehouseTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as WarehouseTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as WarehouseTableColumnKey), 0, moved);
