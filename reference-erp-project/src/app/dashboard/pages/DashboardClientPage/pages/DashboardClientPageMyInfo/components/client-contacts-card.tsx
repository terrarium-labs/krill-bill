...
const ClientContactsCard: React.FC = () => {
        ...
        <CardContent className="py-0 px-4">
          {contacts.length === 0 ? (
            <div className="text-center py-4">
              ...
              <h3 className="text-md font-medium text-muted-foreground">{t("clients.noContacts", "No contacts yet")}</h3>
              <p className="text-muted-foreground mb-4 text-xs">{t("clients.addFirstContact", "Add your first contact to get started")}</p>
            </div>
          ) : (
            <div>
                    ...
                    <div className="flex items-center justify-between gap-2 flex-1 min-w-0">
                      <div className="flex flex-col items-start gap-0">
                        <div className="flex items-center gap-2">
                          ...
                          {contact.is_default && <Tag text={t("clients.default", "Default")} color="yellow" />}
                        </div>
              ...
              {nextPageToken && (
                <div className="text-center pt-4">
                  <Button variant="outline" onClick={() => loadContacts(nextPageToken, true)} disabled={isLoading}>
