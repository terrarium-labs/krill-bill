...
interface DashboardClientPageRatesCommutingProps {
  onAddCommutingRateClick?: () => void;
}

export interface DashboardClientPageRatesCommutingRef {
  refreshCommutingRates: () => void;
}

const DashboardClientPageRatesCommuting = forwardRef<
  DashboardClientPageRatesCommutingRef,
  DashboardClientPageRatesCommutingProps
>(({ onAddCommutingRateClick }, ref) => {
  ...
  const clientId = client?.id ?? "";
    ...
    const handleDeleteConfirm = (clientCommutingRate: CommutingRate) => {
        setCommutingRateToDelete(clientCommutingRate);
    ...
    const handleRowClick = (clientCommutingRate: CommutingRate) => {
        setSelectedCommutingRate(clientCommutingRate);
    ...
    const renderActions = (clientCommutingRate: CommutingRate) => {
        return (
                ...
                items={[
                    {
                        ...
                        icon: "external-link",
                        onClick: () => handleNavigateToCommutingRate(clientCommutingRate.id),
                    },
                    {
                        label: t("common.delete", "Delete"),
                        icon: "trash-2",
                        onClick: () => handleDeleteConfirm(clientCommutingRate),
                        variant: "destructive",
                    },
                ]}
            />
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <ClientCommutingRatesTable
                commutingRates={commutingRates as CommutingRate[]}
                isLoading={isLoading}
...
export default DashboardClientPageRatesCommuting;
