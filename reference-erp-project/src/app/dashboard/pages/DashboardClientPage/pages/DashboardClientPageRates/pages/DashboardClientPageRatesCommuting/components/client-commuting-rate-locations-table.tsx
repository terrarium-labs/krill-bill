...
type CommutingRateLocationsTableProps = {
    locations: Location[];
    isLoading: boolean;
    searchQuery?: string;
...
const CommutingRateLocationsTableComponent = ({
    locations,
    isLoading,
    searchQuery = "",
    renderActions,
    onAddLocation,
}: CommutingRateLocationsTableProps) => {
                                ...
                                <div className="flex items-center justify-center space-y-4 flex-col">
                                    ...
                                    <div className="flex flex-col items-center justify-center">
                                        <h3 className="text-lg font-medium">
                                            {searchQuery
                                                ? t("locations.noResultsFound", "No locations found")
                                                : t("clients.commutingRates.noLocations", "No locations")}
                                        </h3>
                                        <p className="text-muted-foreground">
                                            {searchQuery
                                                ? t("locations.noResultsDescription", "No locations match your search for '{{searchQuery}}'", { searchQuery })
                                                : t("clients.commutingRates.noLocationsDescription", "No locations assigned to this commuting rate.")}
                                        </p>
                                    </div>
                                    {onAddLocation && (
...
export const CommutingRateLocationsTable = memo(CommutingRateLocationsTableComponent);
export default CommutingRateLocationsTable;
