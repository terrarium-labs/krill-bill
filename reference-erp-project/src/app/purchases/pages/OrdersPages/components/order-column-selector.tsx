...
import type { OrderTableColumnKey } from "./orders-table";

export const CONFIGURABLE_COLUMNS: { id: OrderTableColumnKey; label: string }[] = [
    { id: "origin", label: "Origin" },
    { id: "id", label: "ID" },
    { id: "serial_number", label: "Order #" },
    { id: "supplier", label: "Supplier" },
    { id: "order_date", label: "Order Date" },
    { id: "due_date", label: "Due Date" },
    { id: "status", label: "Status" },
    { id: "reception_status", label: "Reception" },
...
export function OrderColumnSelector({
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as OrderTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as OrderTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as OrderTableColumnKey), 0, moved);
