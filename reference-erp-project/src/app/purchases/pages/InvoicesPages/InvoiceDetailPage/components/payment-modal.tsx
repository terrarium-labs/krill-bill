...
import { postPurchaseInvoicePayment, patchPurchaseInvoicePayment } from "@/api/purchase-invoices/payments/payments";
    ...
    const handleSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            if (isEditing && payment) {
                response = await patchPurchaseInvoicePayment(orgId, invoiceId, payment.id, payload);
            } else {
                response = await postPurchaseInvoicePayment(orgId, invoiceId, payload);
            }
