...
import type { PurchaseInvoiceTableColumnKey } from "./purchase-invoices-table";

export const CONFIGURABLE_COLUMNS: { id: PurchaseInvoiceTableColumnKey; label: string }[] = [
    ...
    { id: "subtotal_with_discount", label: "Subtotal" },
    { id: "taxes", label: "Taxes" },
    { id: "total", label: "Total" },
    { id: "created_at", label: "Created At" },
];

interface PurchaseInvoiceColumnSelectorProps {
...
export function PurchaseInvoiceColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: PurchaseInvoiceColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as PurchaseInvoiceTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as PurchaseInvoiceTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as PurchaseInvoiceTableColumnKey), 0, moved);
