...
import type { SigningRequestsTableColumnKey } from "./signing-requests-table";

export const CONFIGURABLE_COLUMNS: { id: SigningRequestsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "workflow_type", label: "Workflow" },
    { id: "progress", label: "Signatures" },
    { id: "overall_status", label: "Status" },
    { id: "description", label: "Description" },
    { id: "number_of_signers", label: "Signers" },
    { id: "created_at", label: "Created" },
    { id: "updated_at", label: "Updated" },
];

interface SigningRequestColumnSelectorProps {
...
export function SigningRequestColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: SigningRequestColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as SigningRequestsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as SigningRequestsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as SigningRequestsTableColumnKey), 0, moved);
