...
import type { VehicleTableColumnKey } from "./vehicles-table";

export const CONFIGURABLE_COLUMNS: { id: VehicleTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    ...
    { id: "origin_city", label: "City" },
    { id: "origin_country", label: "Country" },
];

interface VehicleColumnSelectorProps {
...
export function VehicleColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: VehicleColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as VehicleTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as VehicleTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as VehicleTableColumnKey), 0, moved);
