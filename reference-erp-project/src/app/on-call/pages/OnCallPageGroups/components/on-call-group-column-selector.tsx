...
import type { OnCallGroupsTableColumnKey } from "./on-call-groups-table";

export const CONFIGURABLE_COLUMNS: { id: OnCallGroupsTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "description", label: "Description" },
    { id: "num_employees", label: "Employees" },
    { id: "color", label: "Color" },
];

interface OnCallGroupColumnSelectorProps {
...
export function OnCallGroupColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: OnCallGroupColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as OnCallGroupsTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as OnCallGroupsTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as OnCallGroupsTableColumnKey), 0, moved);
