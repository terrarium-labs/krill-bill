...
import type { HourlyRateTableColumnKey } from "./hourly-rates-table";

export const CONFIGURABLE_COLUMNS: { id: HourlyRateTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    { id: "status", label: "Status" },
    { id: "valid_from", label: "Valid From" },
    { id: "due_date", label: "Valid To" },
    { id: "number_job_titles", label: "Job Titles" },
];

interface HourlyRateColumnSelectorProps {
...
export function HourlyRateColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: HourlyRateColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as HourlyRateTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as HourlyRateTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as HourlyRateTableColumnKey), 0, moved);
