...
import type { CommutingRateTableColumnKey } from "./commuting-rates-table";

export const CONFIGURABLE_COLUMNS: { id: CommutingRateTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
...
interface CommutingRateColumnSelectorProps {
...
export function CommutingRateColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: CommutingRateColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as CommutingRateTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as CommutingRateTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as CommutingRateTableColumnKey), 0, moved);
