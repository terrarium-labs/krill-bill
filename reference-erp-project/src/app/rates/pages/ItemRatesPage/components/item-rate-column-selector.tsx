...
import type { ItemRateTableColumnKey } from "./item-rates-table";

export const CONFIGURABLE_COLUMNS: { id: ItemRateTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
...
interface ItemRateColumnSelectorProps {
...
export function ItemRateColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: ItemRateColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as ItemRateTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as ItemRateTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as ItemRateTableColumnKey), 0, moved);
