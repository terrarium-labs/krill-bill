...
import type { SupplierTableColumnKey } from "./suppliers-table";

export const CONFIGURABLE_COLUMNS: { id: SupplierTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
...
interface SupplierColumnSelectorProps {
...
export function SupplierColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: SupplierColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as SupplierTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as SupplierTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as SupplierTableColumnKey), 0, moved);
