...
import type { WorkOrderTableColumnKey } from "./work-orders-table";

export const CONFIGURABLE_COLUMNS: { id: WorkOrderTableColumnKey; label: string }[] = [
    { id: "id", label: "ID" },
    { id: "name", label: "Name" },
    ...
    { id: "is_billed", label: "Is Billed" },
    { id: "is_paid", label: "Is Paid" },
    { id: "origin", label: "Origin" },
    { id: "created_at", label: "Created At" },
];

interface WorkOrderColumnSelectorProps {
...
export function WorkOrderColumnSelector({
    columnVisibility,
    columnOrder,
    onColumnVisibilityChange,
    onColumnOrderChange,
    onReset,
}: WorkOrderColumnSelectorProps) {
    ...
    const orderedColumns = (() => {
        ...
        const ordered = columnOrder.filter((id) =>
            configurableIds.includes(id as WorkOrderTableColumnKey),
        );
    ...
    const handleDrop = (targetId: string) => {
        ...
        const reordered = [...ids];
        const [moved] = reordered.splice(ids.indexOf(sourceId as WorkOrderTableColumnKey), 1);
        reordered.splice(ids.indexOf(targetId as WorkOrderTableColumnKey), 0, moved);
