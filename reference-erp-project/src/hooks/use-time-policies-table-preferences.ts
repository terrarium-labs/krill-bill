...
const STORAGE_KEY = "laia:time-policies-table-prefs";
    ...
    try {
        ...
        if (stored) {
            ...
            return {
                ...defaultPreferences,
                ...parsed,
                columnVisibility: { ...defaultColumnVisibility, ...(parsed.columnVisibility ?? {}) },
            };
        }
    } catch {
        // ignore parse errors
...
export function useTimePoliciesTablePreferences() {
