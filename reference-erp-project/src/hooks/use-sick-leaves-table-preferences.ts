...
const STORAGE_KEY = "laia:sick-leaves-table-prefs";
    ...
    try {
        ...
        if (stored) {
            ...
            return {
                ...defaultPreferences,
                ...parsed,
                // Deep-merge so newly added columns still start hidden for existing users.
                columnVisibility: {
...
export function useSickLeavesTablePreferences() {
