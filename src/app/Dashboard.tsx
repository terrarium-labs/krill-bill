export default function Dashboard() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Welcome to Krill Bill</h1>
        <p className="text-gray-600 mt-2">Your local-first invoice manager SaaS</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-gray-600 mt-2">Invoices Created</p>
        </div>
